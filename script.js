const itemsObject = [
  {
    ...
    itemDescription: [
      "Delicious berries and wholesome ingredients such as carrots and bilberries to brighten up your day: Tart cherry, Carrot, Blackberry, Pomegranate, Bilberry, Cranberry, Acai",
    ],
    itemPrice: "5€",
  },

  {
    ...
    itemTags: ["Juice, Vegan, Organic, Gluten-free"],
    itemDescription:
      "A refreshing boost in a bottle with those daily vitamins and minerals you need for a great day : Kale, Cucumber, Apple, Spinach, Mint, Celery, Lime, Parsleyn",
    itemPrice: "5€",
  },
